...
const Footer = () => {
  ...
  const socialLinks = [
    { name: 'LinkedIn', icon: Linkedin, href: 'https://www.linkedin.com/in/iamabhishekmohanty/' },
    { name: 'GitHub', icon: Github, href: 'https://github.com/nawseekhiya/aqua-aware' },
  ];
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8">
          <div className="lg:col-span-2">
            ...
            <p className="mt-4 text-gray-600 dark:text-gray-400 max-w-md">
              Committed to raising awareness about water pollution in India through education, research, and community engagement.
            </p>
