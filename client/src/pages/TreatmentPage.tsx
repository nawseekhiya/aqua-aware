  ...
  diy: [
    {
      id: 'd1',
      title: 'Boiling',
      description: 'Heat water to rolling boil for at least one minute to kill most pathogens',
      effectiveAgainst: ['Bacteria', 'Viruses', 'Protozoa'],
      notEffectiveAgainst: ['Chemical pollutants', 'Heavy metals', 'Pesticides'],
      instructions: [
    ...
    },
    {
      ...
      description: 'Using sunlight and transparent PET bottles to disinfect water',
      effectiveAgainst: ['Bacteria', 'Viruses', 'Some protozoa'],
      notEffectiveAgainst: ['Chemical pollutants', 'Heavy metals', 'Highly turbid water'],
      instructions: [
    ...
    },
    {
      ...
      description: 'Using folded cotton cloth to remove larger particles and some pathogens',
      effectiveAgainst: ['Large particles', 'Some bacteria', 'Cholera-causing bacteria'],
      notEffectiveAgainst: ['Most pathogens', 'Chemicals', 'Dissolved contaminants'],
      instructions: [
    ...
    },
    {
      ...
      notEffectiveAgainst: ['Most pathogens', 'Heavy metals', 'Many dissolved substances'],
      instructions: [
    ...
    },
    {
      ...
      description: 'Using alum (potassium aluminum sulfate) to precipitate particles',
  ...
  lab: [
    {
      ...
      description: 'Forcing water through a semi-permeable membrane to remove contaminants',
      effectiveAgainst: ['Most dissolved substances', 'Bacteria', 'Viruses', 'Heavy metals'],
      notEffectiveAgainst: ['Some volatile organic compounds', 'Certain pesticides'],
      process: [
    ...
    },
    {
      ...
      effectiveAgainst: ['Bacteria', 'Viruses', 'Protozoa'],
      notEffectiveAgainst: ['Chemical contaminants', 'Turbid water', 'Dissolved substances'],
      process: [
    ...
    },
    {
      id: 'l3',
      title: 'Ozonation',
      description: 'Injecting ozone gas to oxidize contaminants and kill pathogens',
      effectiveAgainst: ['Bacteria', 'Viruses', 'Many organic compounds', 'Some pesticides'],
    ...
    },
    {
      ...
      description: 'Combining techniques to produce hydroxyl radicals for contaminant breakdown',
      effectiveAgainst: ['Persistent organic pollutants', 'Pharmaceuticals', 'Industrial chemicals'],
    ...
    },
    {
      ...
      effectiveAgainst: ['Hardness minerals', 'Heavy metals', 'Nitrates', 'Radionuclides'],
...
const TreatmentPage = () => {
  ...
  const currentTreatments = activeTab === 'diy' ? treatments.diy : treatments.lab;
    ...
    <div className="min-h-screen py-20">
      <div className="container mx-auto px-6">
        ...
        <p className="text-lg text-gray-600 dark:text-gray-400 max-w-3xl mx-auto text-center mb-16">
          Discover effective ways to treat polluted water, from simple DIY solutions to advanced laboratory techniques.
        </p>
